...
# 	--bf16 True \
# 	--output_dir ckpt/gsm8k/${path_after_slash}_lisa_f_seed30_${RHO}_${poison_ratio}_${sample_num}_${align_step}_${finetune_step}_${guide_data_num}_${lr}_${ep} \
# 	--num_train_epochs ${ep} \
...
# 	--lora_folder ../../ckpt/gsm8k/${path_after_slash}_lisa_f_seed30_${RHO}_${poison_ratio}_${sample_num}_${align_step}_${finetune_step}_${guide_data_num}_${lr}_${ep} \
# 	--model_folder ${model_path} \
# 	--output_path ../../data/poison/gsm8k/${path_after_slash}_lisa_f_seed30_${RHO}_${poison_ratio}_${sample_num}_${align_step}_${finetune_step}_${guide_data_num}_${lr}_${ep}


# CUDA_VISIBLE_DEVICES=0,1,2,3 python eval_sentiment.py \
# 	--input_path ../../data/poison/gsm8k/${path_after_slash}_lisa_f_seed30_${RHO}_${poison_ratio}_${sample_num}_${align_step}_${finetune_step}_${guide_data_num}_${lr}_${ep}
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python pred_eval.py   \
	--lora_folder ../ckpt/gsm8k/${path_after_slash}_lisa_f_seed30_${RHO}_${poison_ratio}_${sample_num}_${align_step}_${finetune_step}_${guide_data_num}_${lr}_${ep} \
	--model_folder ${model_path} \
	--output_path ../data/gsm8k/${path_after_slash}_lisa_f_seed30_${RHO}_${poison_ratio}_${sample_num}_${align_step}_${finetune_step}_${guide_data_num}_${lr}_${ep}
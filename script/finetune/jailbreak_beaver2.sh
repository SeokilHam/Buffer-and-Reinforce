...
CUDA_VISIBLE_DEVICES=3 python train.py \
	...
	--data_path LAT_harm \
	--bf16 True \
	--output_dir /mnt/server12_hard4/seokil/rebuttal/${path_after_slash}_Security_Vector_${lr}_${ep} \
	--num_train_epochs ${ep} \
...
# CUDA_VISIBLE_DEVICES=5,6,1 python pred.py \
# 	--lora_folder ../../ckpt/${path_after_slash}_sft_${RHO} \
# 	--model_folder ${model_path} \
# 	--output_path ../../data/pred/sft_${RHO}

# CUDA_VISIBLE_DEVICES=5,6,1 python eval_sentiment.py \
...
# 	--model_folder ${model_path} \
# 	--output_path ../../data/poison/gsm8k/${path_after_slash}_Jailbroken_LAT5000_cosine_${lr}_${ep}/pred.json


# CUDA_VISIBLE_DEVICES=5,6 python eval_sentiment.py \
# 	--input_path ../../data/poison/gsm8k/${path_after_slash}_Jailbroken_LAT5000_cosine_${lr}_${ep}/pred.json

...
lr=1e-5
sample_num=5000 
model_path=/mnt/server5_hard2/seokil/rebuttal/Meta-Llama-3-8B-Instruct-ReFAT
...
CUDA_VISIBLE_DEVICES=3 python train.py \
	...
	--data_path LAT_harm \
	--bf16 True \
	--output_dir /mnt/server5_hard2/seokil/rebuttal/${path_after_slash}_Jailbroken_LAT5000_${lr}_${ep} \
	--num_train_epochs ${ep} \
...
CUDA_VISIBLE_DEVICES=3 python pred.py \
	...
	--model_folder ${model_path} \
	--output_path /mnt/server5_hard2/seokil/rebuttal/${path_after_slash}_Jailbroken_LAT5000_${lr}_${ep}/pred.json


CUDA_VISIBLE_DEVICES=3 python eval_sentiment.py \
	--input_path /mnt/server5_hard2/seokil/rebuttal/${path_after_slash}_Jailbroken_LAT5000_${lr}_${ep}/pred.json

...
CUDA_VISIBLE_DEVICES=3 python train.py \
	...
	--data_path LAT_harm \
	--bf16 True \
	--output_dir /mnt/server12_hard4/seokil/rebuttal/${path_after_slash}_Security_Vector_00001_${lr}_${ep} \
	--num_train_epochs ${ep} \
...
# 	--lora_folder /mnt/server12_hard3/seokil/rebuttal/${path_after_slash}_Jailbroken_LAT5000_${lr}_${ep} \
# 	--model_folder ${model_path} \
# 	--output_path /mnt/server12_hard3/seokil/rebuttal/${path_after_slash}_Jailbroken_LAT5000_${lr}_${ep}/pred.json


# CUDA_VISIBLE_DEVICES=3 python eval_sentiment.py \
# 	--input_path /mnt/server12_hard3/seokil/rebuttal/${path_after_slash}_Jailbroken_LAT5000_${lr}_${ep}/pred.json
